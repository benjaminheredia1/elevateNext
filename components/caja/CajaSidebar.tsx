...
const Icons = {
  ...
  recepciones: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9h18v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M3 9 5 4h14l2 5"/><path d="M12 13v4"/><path d="m10 15 2 2 2-2"/></svg>,
...
export const NAV_ITEMS = [
  ...
  { to: '/caja/clientes', label: 'Clientes', icon: Icons.clientes },
  { to: '/caja/insumos', label: 'Insumos', icon: Icons.insumos },
  { to: '/caja/recepciones', label: 'Recepciones', icon: Icons.recepciones },
