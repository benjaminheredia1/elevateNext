...
export const asignarPrivilegiosSchema = z.object({
  privilegio_ids: z.array(z.coerce.number().int().positive()),
});
...
export type AsignarPrivilegiosInput = z.infer<typeof asignarPrivilegiosSchema>;
